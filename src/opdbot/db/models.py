...
class Goal(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    code: Mapped[GoalCode] = mapped_column(Enum(GoalCode), unique=True, nullable=False)
...
class DocumentRequirement(Base):
    ...
    allowed_mime: Mapped[str] = mapped_column(String(256), default="pdf,jpg,jpeg,png", nullable=False)
...
class Document(Base):
    ...
    requirement_id: Mapped[int] = mapped_column(Integer, ForeignKey("document_requirements.id"), nullable=False)
...
class GeneratedDocument(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    application_id: Mapped[int] = mapped_column(Integer, ForeignKey("applications.id"), nullable=False)
    kind: Mapped[GeneratedDocumentKind] = mapped_column(Enum(GeneratedDocumentKind), nullable=False)
    file_path: Mapped[str] = mapped_column(String(512), nullable=False)
...
class Slot(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    kind: Mapped[SlotKind] = mapped_column(Enum(SlotKind), nullable=False)
...
class Message(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    application_id: Mapped[int] = mapped_column(Integer, ForeignKey("applications.id"), nullable=False)
    from_role: Mapped[MessageFromRole] = mapped_column(Enum(MessageFromRole), nullable=False)
...
class AuditLog(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    application_id: Mapped[Optional[int]] = mapped_column(Integer, ForeignKey("applications.id"))
